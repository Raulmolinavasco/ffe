        ...
        if($planformativo[0]->autorizacion_extras == "Realiza fuera de la comunidad"){
            ...
            if($planformativo[0]->autorizacion_extras == "Otras"){
                ...
                if($planformativo[0]->distribucion == "Otros"){
                    ...
                    $table = new Table(array('borderSize' => 12, 'borderColor' => 'green', 'width' => 9700, 'unit' => TblWidth::TWIP));
                    $table->addRow();
                    ...
                    $modulos = Modulo::where('curso_id',$planformativo[0]->curso_id)->get();
                   // dd($modulos);
                    ...
                    foreach($modulos as $dato){
                      ...
                      //  $textRun = $cell->addTextRun();
                        ...
                        $nestedTable = $cell->addTable(array('cellMargin' => 0,'borderSize' => 0, 'spacing' => 0,'borderColor' => 'green',  'width' => 6600, 'unit' => TblWidth::TWIP, 'alignment' => JcTable::CENTER));
                        $nestedTable->addRow();
                        $nestedTable->addCell(20)->addText($dato->nombre,['valign' => 'top','bold' => true]);
                        $nestedTable->addCell(100)->addText($dato->descripcion,['valign' => 'top']);
                        ...
                        $nestedTable->addCell(25,['valign' => 'center','alignment' => Jc::CENTER])->addText('■',['alignment' => Jc::CENTER,'valign' => 'center','spaceAfter' => 0] );
                        $nestedTable->addCell(20,['valign' => 'center','alignment' => Jc::CENTER])->addText('□',['alignment' => Jc::CENTER,'valign' => 'center', 'spaceAfter' => 0] );
                        }else {
                        $nestedTable->addCell(25,['valign' => 'center','alignment' => Jc::CENTER])->addText('□',['alignment' => Jc::CENTER,'valign' => 'center', 'spaceAfter' => 0] );
                        $nestedTable->addCell(20,['valign' => 'center','alignment' => Jc::CENTER])->addText('■',['alignment' => Jc::CENTER,'valign' => 'center', 'spaceAfter' => 0] );
                        }
                    ...
                    $table1 = new Table(array('borderSize' => 12, 'borderColor' => 'green', 'width' => 9700, 'unit' => TblWidth::TWIP, 'alignment' => JcTable::CENTER));
                    $table1->addRow();
                   ...
                   // dd($planformativora2);
                    ...
                    foreach($planformativora2 as $dato){
                      ...
                      //  $textRun = $cell->addTextRun();
                        ...
                        $nestedTable1 = $cell1->addTable(array('cellMargin' => 0,'borderSize' => 0, 'spacing' => 0,'borderColor' => 'green',  'width' => 6600, 'unit' => TblWidth::TWIP));
                        $nestedTable1->addRow();
                        $nestedTable1->addCell(20)->addText(Ra::where('id',$dato)->pluck('nombre')[0],['valign' => 'top','bold' => true]);
                        $nestedTable1->addCell(100)->addText(Ra::where('id',$dato)->pluck('descripcion')[0],['valign' => 'top']);
                        //$planformativoId1 = $planformativo[0]->id;
                        //$raId1 = $dato->id;
                        $nestedTable1->addCell(25,['valign' => 'center'])->addText('■','alignCenter');
                        $nestedTable1->addCell(20,['valign' => 'center'])->addText('□');
                        }
